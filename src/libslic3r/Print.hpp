...
public:
    ...
    static bool update_layer_density_profile(const ModelObject &model_object, const SlicingParameters &slicing_parameters, std::vector<coordf_t> &layer_height_profile, std::vector<coordf_t> &layer_density_profile);
