...
{
    static std::vector<std::string> s_opts {//TODO did stuff here
        ...
        "start_filament_gcode", "end_filament_gcode", "variable_filament_density", "foaming_min_temp", "foaming_max_temp",
        // Retract overrides
